...
col = [     
            ...
            [sg.Text('\r')],
            [sg.Button(image_filename='prov.png',button_color='#FFFFFF', key='provisionar')],  
            [sg.Button(image_filename='remove.png',button_color='#FFFFFF', key='remover'),
             sg.Button(image_filename='clean.png',button_color='#FFFFFF',key='Limpar')],
            [sg.Text('            Comandos Adicionais')], 
            [sg.Button(image_filename='position.png',button_color='#FFFFFF', key='position')], 
            [sg.Button(image_filename='unprovision.png',button_color='#FFFFFF', key='semuso')],
            [sg.Button(image_filename='semuso.png',button_color='#FFFFFF', key='remover'),
             sg.Button(image_filename='buscar.png',button_color='#FFFFFF',key='Limpar')],
